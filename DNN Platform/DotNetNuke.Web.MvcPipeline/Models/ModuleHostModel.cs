...
namespace DotNetNuke.Web.MvcPipeline.Models
{
    ...
    public sealed class ModuleHostModel
    {
        ...
        /// </summary>
        public ModuleHostModel(ModuleInfo moduleConfiguration, SkinModel skin, ContainerModel container)
        {
        ...
        public SkinModel Skin { get; private set; }

        public ControllerContext Page { get; private set; }
        ...
        private static void InjectMessageControl()
        {
            // inject a message placeholder for common module messaging - UI.Skins.Skin.AddModuleMessage
            /*
        ...
        */
        ...
        private void InjectModuleContent()
        {
            /*
            ...
            foreach (Match match in matches)
            {
                ...
                switch (dependencyType)
                {
                    case "JAVASCRIPT":
                        ...
                        MvcClientResourceManager.RegisterScript(this.Page, filePath, priority, forceProvider);
                        break;
                    case "CSS":
                        if (string.IsNullOrEmpty(forceProvider))
                        {
                        ...
                        MvcClientResourceManager.RegisterStyleSheet(this.Page, filePath, priority, forceProvider);
                        break;
                    case "JS-LIBRARY":
