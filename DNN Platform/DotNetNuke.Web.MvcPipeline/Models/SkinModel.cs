...
namespace DotNetNuke.Web.MvcPipeline.Models
{
    ...
    public class SkinModel
    {
        ...
        public static SkinModel GetSkin(DnnPageController page, PageModel pageModel)
        {
            SkinModel skin = null;
            ...
            if (page.Request.QueryString["SkinSrc"] != null)
            {
                ...
                skin = LoadSkin(page, pageModel, skinSource);
            }
        ...
        public static SkinModel GetPopUpSkin(DnnPageController page, PageModel pageModel)
        {
            SkinModel skin = null;
        ...
        private static SkinModel LoadSkin(DnnPageController page, PageModel pageModel, string skinPath)
        {
            ...
            try
            {
                ...
                */
                ctlSkin = new SkinModel(page, pageModel);
